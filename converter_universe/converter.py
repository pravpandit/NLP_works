...
def translate_text(text, src_lang='zh', dest_lang='en'):
...
# Example usage
root_directory = r'praveen_data/llm-universe-main'  # Path to the root directory containing notebooks and markdown files
